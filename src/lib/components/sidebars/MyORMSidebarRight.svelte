...
<Accordion>
        ...
        <svelte:fragment slot="content">
            <ul class="h-auto">
                <li class="px-1 hover:bg-tertiary-hover-token" class:border-l-4={$currentSection == "#constructor"}>
                    <a on:click|preventDefault={scrollIntoView} href="#constructor">new KinshipContext()</a>
                </li>
    ...
    <AccordionItem bind:open={accordionItemOpenStates.types}>
        ...
        <svelte:fragment slot="content">
            <ul class="h-auto">
                <li class="px-1 hover:bg-tertiary-hover-token" class:border-l-4={$currentSection == "#Kinship-adapter"}>
                    <a on:click|preventDefault={scrollIntoView} class="px-1 hover:bg-tertiary-hover-token" href="#Kinship-adapter">MyORMAdapter</a>
                </li>
