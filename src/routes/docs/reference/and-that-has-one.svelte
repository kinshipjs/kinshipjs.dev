...
<div class="p-4">
    <Docs {exampleCode}>
        Further configure one-to-one relationship from the last configured relationship on your <code class="code">KinshipContext</code> class object to be included in future queries.
