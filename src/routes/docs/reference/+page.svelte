<script>
    ...
    import { appShellScrollY, breadcrumbs } from '../../+layout.svelte';
...
<section class="label" id="clause-functions">
    ...
    <p>
        All clause functions return a <ScrollIntoViewAnchor isCode href="#constructor" label="new KinshipContext"/> with a new state tailored to the original context and the new clauses added onto it.
...
<section class="label" id="types">
    ...
    <section id="Kinship-adapter"><h2 class="h2">&lt;MyORMAdapter&gt;</h2></section>
    <hr>
