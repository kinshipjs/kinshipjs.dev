<script>
    ...
    const exampleCode = `import { KinshipContext } from "@Kinship/Kinship";
...
ctx.where(m => m.TrackId.equals(20))
    ...
    const chainingExampleCode = `import { KinshipContext } from "@Kinship/Kinship";
// initialize connection with desired adapter as \`connection\`.
const ctx: KinshipContext<Track> = new KinshipContext(connection, "Track"));
ctx.where(m => m.TrackId.equals(20)
    ...
    const nestingExampleCode = `import { KinshipContext } from "@Kinship/Kinship";
// initialize connection with desired adapter as \`connection\`.
const ctx: KinshipContext<Track> = new KinshipContext(connection, "Track"));
ctx.where(m => m.TrackId.equals(20)
    .and(m => m.Composer.equals("AC/DC")
    ...
    const sequentialExampleCode = `import { KinshipContext } from "@Kinship/Kinship";
// initialize connection with desired adapter as \`connection\`.
const ctx: KinshipContext<Track> = new KinshipContext(connection, "Track"));
ctx.where(m => m.TrackId.equals(20))
