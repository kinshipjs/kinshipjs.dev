...
const ctx: KinshipContext<Track> = new KinshipContext(connection, "Playlist"));
...
<div class="p-4">
    <Docs {exampleCode}>
        Further configure a one-to-many relationship from the last configured relationship on your <code class="code">KinshipContext</code> class object to be included in future queries.
        ...
        <svelte:fragment slot="returns">
            <ReturnType type="KinshipContext">
                Same reference to the <code class="code">KinshipContext</code> class object.
            </ReturnType>
        </svelte:fragment>
    </Docs>
</div>