    ...
    <Docs>
        ...
        <svelte:fragment slot="returns">
            <ReturnType type="KinshipContext">
                A reference to the same <code class="code">KinshipContext</code> with a new state that negates any filter condition. (condition can be past or applied in the future).
            </ReturnType>
        </svelte:fragment>
